...
glm::vec3 lightPos(-2.0f, 0.7f, 0.2f);
...
int main() {
  ...
  Shader lightingShader("shader/lesson5/object.vs", "shader/lesson5/object.fs");
  Shader lightCubeShader("shader/lesson5/lightCube.vs",
                         "shader/lesson5/lightCube.fs");
